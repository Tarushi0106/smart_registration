...
// Simple /api/register endpoint for demo
...
//   if (password !== confirmPassword) errors.push({ path: 'confirmPassword', msg: 'Passwords must match' });
  ...
  // In a real app you'd save the user here. Return success for the demo.
...
// Start server and auto-increment port if it's already in use
